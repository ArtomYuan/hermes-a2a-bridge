...
A bridge plugin on the Hermes side that connects to the dsh A2A server.
...
Repository: <https://github.com/ArtomYuan/hermes-a2a-bridge>
...
GPL-3.0 (see `LICENSE`) — this project is an independent, self-built plugin.
